...
public class ManagingOptionsOverFileDataTest {
	...
	private void testSwap(String inputFile, int[] ToBeSwappedWordsParameters) throws FileNotFoundException {
        ...
        boolean wordsAreSwapped = false;
        
        if(expectedFirstWordWithNewCoordinates.equals(wordToBeChecked))
        {
        	wordsAreSwapped = true;
        }
       
        assertEquals(true, wordsAreSwapped);
	}
